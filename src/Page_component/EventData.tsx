...
const EventData: React.FC<EventDataProps> = ({ data }) => {
  ...
  // Context functions for editing and deleting events
  ...
  const [importance, setImportance] = useState<string>(data.importance || "");

  // Handle saving changes
  const handleSave = () => {
    setEdit(!edit); // Toggle edit mode
    EditEvent(day, month, startTime, endTime, id, name, description, importance); // Call EditEvent with updated values
  };
